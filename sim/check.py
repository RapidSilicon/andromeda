...
# feat = feat/output_scale
# pred1 = keras_task(keras_encoder(data))
# pred2 = keras_task(tflite_encoder(data)/output_scale)
# pred3 = keras_task(feat)
# accuracy{123} = round(sigmoid(pred{123}))==label
