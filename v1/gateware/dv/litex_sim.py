...
class SimSoC(SoCCore):
	...
	# Andromeda --------------------------------------------------------------------------------------
        ...
        andromeda_region = SoCRegion(origin=self.mem_map.get("andromeda", None), size=256*64*1024, cached=False)
        self.bus.add_slave(name="andromeda", slave=wb, region=andromeda_region)
        
        platform.add_source("./../andromeda.v")
        platform.add_source("./../soc_if.v")
        platform.add_source("./../rtl_ibuf/ibuf_defines.v")
        platform.add_source("./../rtl_ibuf/ibuf.v")
        platform.add_source("./../rtl_ibuf/i2c_master.v")
        platform.add_source("./../rtl_ibuf/sdp_bram.v")
