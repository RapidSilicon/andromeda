...
parser.add_argument('--tflite', help='tflite flatbuffer model file',default='../model/overhead.tflite')
...
#parser.add_argument('--top', help='top level module name',default='overhead')
...
if args.stride==1:
    ...
    keras.layers.InputLayer(input_shape=(24, 32, 32)),
    keras.layers.Conv2D(filters=16, kernel_size=(3, 4), strides=(1,1), activation=tf.nn.relu, padding='valid'),
    keras.layers.Conv2D(filters=16, kernel_size=(3, 4), strides=(1,1), activation=tf.nn.relu, padding='valid'),
    keras.layers.Conv2D(filters=16, kernel_size=(3, 4), strides=(1,1), activation=tf.nn.relu, padding='valid'),
    keras.layers.Conv2D(filters=16, kernel_size=(3, 4), strides=(1,1), activation=tf.nn.relu, padding='valid'),
    keras.layers.Conv2D(filters=16, kernel_size=(3, 4), strides=(1,1), activation=tf.nn.relu, padding='valid'),
    ...
    keras.layers.Conv2D(filters=16, kernel_size=(3, 4), strides=(1,1), activation=tf.nn.relu, padding='valid'),
    keras.layers.Conv2D(filters=16, kernel_size=(3, 4), strides=(1,1), activation=tf.nn.relu, padding='valid'),
    keras.layers.Conv2D(filters=16, kernel_size=(4, 3), strides=(1,1), activation=tf.nn.relu, padding='valid'),
