...
parser.add_argument('--n', help='test image',default=100, type=int)
parser.add_argument('--img', help='test image',default=None)
...
for d in os.listdir(args.dataset):
    ...
    for f in os.listdir('{}/{}'.format(args.dataset,d)):
        ...
        if args.debug:
            #print('d',d,'f',f,'img.shape',img.shape)
