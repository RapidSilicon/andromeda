...
parser.add_argument('--tflite', help='tflite flatbuffer model file',default='../model/mira220.tflite')
...
keras.layers.InputLayer(input_shape=(1400, 1600, 3)),
...
#keras.layers.Conv2D(filters=16, kernel_size=(3, 3), strides=(2,2), activation=tf.nn.relu, padding='valid'),
#keras.layers.Conv2D(filters=10, kernel_size=(4, 4), strides=(1,1), activation=None, padding='valid'),
#keras.layers.Conv2D(filters=16, kernel_size=(3, 3), strides=(1,1), activation=tf.nn.relu, padding='valid'),
#keras.layers.Conv2D(filters=16, kernel_size=(3, 3), strides=(1,1), activation=tf.nn.relu, padding='valid'),
#keras.layers.Conv2D(filters=10, kernel_size=(3, 3), strides=(1,1), activation=tf.nn.relu, padding='valid'),
...
def representative_dataset():
    for _ in range(10):
        data = np.random.rand(1, 1400, 1600, 3)
