...
//--------------------------------------------------------------------------------
//Command: generate_target bd_d757.bd
//Design : bd_d757
//Purpose: IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "bd_d757,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_d757,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=5,numReposBlks=5,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "capture_mipi_csi2_rx_subsyst_0_0.hwdef" *) 
module bd_d757
   (clkoutphy_out,
    csirxss_csi_irq,
  ...
  wire [31:0]rx_m_axis_eni_TDATA;
  wire [3:0]rx_m_axis_eni_TDEST;
  wire [3:0]rx_m_axis_eni_TKEEP;
  wire rx_m_axis_eni_TLAST;
  wire rx_m_axis_eni_TREADY;
  wire [95:0]rx_m_axis_eni_TUSER;
  wire rx_m_axis_eni_TVALID;
  ...
  assign emb_nonimg_tdata[31:0] = rx_m_axis_eni_TDATA;
  assign emb_nonimg_tdest[3:0] = rx_m_axis_eni_TDEST;
  assign emb_nonimg_tkeep[3:0] = rx_m_axis_eni_TKEEP;
  assign emb_nonimg_tlast = rx_m_axis_eni_TLAST;
  assign emb_nonimg_tuser[95:0] = rx_m_axis_eni_TUSER;
  assign emb_nonimg_tvalid = rx_m_axis_eni_TVALID;
  ...
  assign rx_m_axis_eni_TREADY = emb_nonimg_tready;
  ...
  assign video_out_tuser[31:0] = vfb_0_m_vfb_TUSER;
  ...
  bd_d757_rx_0 rx
       (.cl_enable(phy_rx_mipi_ppi_if_CL_ENABLE),
        ...
        .m_axis_eni_tdata(rx_m_axis_eni_TDATA),
        .m_axis_eni_tdest(rx_m_axis_eni_TDEST),
        .m_axis_eni_tkeep(rx_m_axis_eni_TKEEP),
        .m_axis_eni_tlast(rx_m_axis_eni_TLAST),
        .m_axis_eni_tready(rx_m_axis_eni_TREADY),
        .m_axis_eni_tuser(rx_m_axis_eni_TUSER),
        .m_axis_eni_tvalid(rx_m_axis_eni_TVALID),
