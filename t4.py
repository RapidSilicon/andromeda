...
model = keras.Sequential([
  ...
  keras.layers.Conv2D(filters=64, kernel_size=(3, 3), strides=(2,2), activation=tf.nn.relu, padding='valid'),
  keras.layers.Conv2D(filters=128, kernel_size=(3, 3), strides=(1,1), activation=tf.nn.relu, padding='valid'),
  keras.layers.Conv2D(filters=128, kernel_size=(3, 3), strides=(2,2), activation=tf.nn.relu, padding='valid'),
  keras.layers.Conv2D(filters=128, kernel_size=(3, 3), strides=(1,1), activation=tf.nn.relu, padding='valid'),
  keras.layers.Conv2D(filters=128, kernel_size=(3, 3), strides=(2,2), activation=tf.nn.relu, padding='valid'),
  keras.layers.Conv2D(filters=128, kernel_size=(3, 3), strides=(1,1), activation=tf.nn.relu, padding='valid'),
  keras.layers.Conv2D(filters=128, kernel_size=(3, 3), strides=(2,2), activation=tf.nn.relu, padding='valid'),
  ...
  keras.layers.Conv2D(filters=128, kernel_size=(3, 3), strides=(1,1), activation=tf.nn.relu, padding='valid'),
  keras.layers.Conv2D(filters=128, kernel_size=(3, 3), strides=(1,1), activation=tf.nn.relu, padding='valid'),
  keras.layers.Conv2D(filters=128, kernel_size=(3, 17), strides=(1,1), activation=tf.nn.relu, padding='valid'),
  keras.layers.Conv2D(filters=128, kernel_size=(3, 3), strides=(1,1), activation=tf.nn.relu, padding='valid'),
...
interpreter = tf.lite.Interpreter(model_path='./t4.tflite')
