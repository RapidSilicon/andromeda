...
class BaseSoC(SoCCore):
    def __init__(self, variant="a7-35", toolchain="vivado", sys_clk_freq=int(100e6),
        ...
        # I2C --------------------------------------------------------------------------------------
        i2c_io = platform.request("i2c")
        self.submodules.i2c = I2CMaster(i2c_io)
        self.submodules.sda_pup = GPIOTristate(i2c_io.sda_pup)
        self.submodules.scl_pup = GPIOTristate(i2c_io.scl_pup)
