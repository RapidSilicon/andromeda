...
parser.add_argument('--img', help='test image file',default='dataset2/two_001/frame00100.jpg')
...
# first run inference on tflite reference
input_data = img
...
pred = np.argmax(p)
print('img',args.img,'pred',pred,'p',p)
for k in range(24,36):
    print('T{}'.format(k),interpreter.get_tensor(k))

#input_data = test_images[args.n]
#input_data = input_data / input_scale + input_zero_point
input_data = img / input_scale
